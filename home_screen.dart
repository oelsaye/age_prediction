...
class _HomeScreenState extends State<HomeScreen> {
  ...
  String description = 'Enter your name and Country!';
  ...
  void setupNameAPI(String name, String country) async {
    ...
    if (startup.age! == null)
    {
      description = 'Your name is not available in this country! :(';
    }
    else
    {
      ...
      description = 'Age : $age for $userName in $countryname';
    }
        ...
        child: Column(
          children: [
            ...
            DropdownButton<String>(
              ...
              items: <String>['Country', 'France', 'Italy', 'Lebanon',
